...
public class GameActivity extends SDLActivity {
	...
	private Integer cachedLastDialogType = null; // Cache for last dialog type
	private String cachedDialogMessage = null;  // Cache for dialog message
	...
	public void showTextInputDialog(String hint, String current, int editType) {
		// Consider optimizing UI updates here, possibly batching or reducing complexity
